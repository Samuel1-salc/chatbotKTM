const { Client, Location, Poll, List, Buttons } = require('whatsapp-web.js');
const LocalAuth = require('../node_modules/whatsapp-web.js/src/authStrategies/LocalAuth.js');

const client = new Client({
    authStrategy: new LocalAuth(),
    // proxyAuthentication: { username: 'username', password: 'password' },
    puppeteer: { 
        executablePath: '/usr/bin/google-chrome', // Default location for Google Chrome
        headless: false,
    }
});
